...
@click.command()
@click.option('--output', '-o', help = "Path to the output directory where the report will be generated.", type = str, default = "smryz_output", show_default = True)
...
@click.option('--author', '-a', help = "Author of the report.", type = str, default = "datasmryzr", show_default = True)
